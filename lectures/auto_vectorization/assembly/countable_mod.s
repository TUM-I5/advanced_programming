...
# mark_description "-O2 -mavx -S -masm=intel -DCOUNTABLE";
...
..B1.4:                         # Preds ..B1.4 ..B1.3
  vmovupd   ymm0, YMMWORD PTR [rsp+rax*8]                 #38.16
  vmovupd   ymm2, YMMWORD PTR [32+rsp+rax*8]              #38.16
  vmovupd   ymm4, YMMWORD PTR [64+rsp+rax*8]              #38.16
  vmovupd   ymm6, YMMWORD PTR [96+rsp+rax*8]              #38.16
  vmulpd    ymm1, ymm0, YMMWORD PTR [2048+rsp+rax*8]      #38.27
  vmulpd    ymm3, ymm2, YMMWORD PTR [2080+rsp+rax*8]      #38.27
  vmulpd    ymm5, ymm4, YMMWORD PTR [2112+rsp+rax*8]      #38.27
  vmulpd    ymm7, ymm6, YMMWORD PTR [2144+rsp+rax*8]      #38.27
  vmovupd   YMMWORD PTR [4096+rsp+rax*8], ymm1            #38.5
  vmovupd   YMMWORD PTR [4128+rsp+rax*8], ymm3            #38.5
  vmovupd   YMMWORD PTR [4160+rsp+rax*8], ymm5            #38.5
  vmovupd   YMMWORD PTR [4192+rsp+rax*8], ymm7            #38.5
  add       rax, 16                                       #33.3
  cmp       rax, 256                                      #33.3
...
..B1.6:                         # Preds ..B1.8 ..B1.5
        ...
        vmovsd    xmm0, QWORD PTR [4096+rsp+r12*8]              #43.15
        vzeroupper                                              #43.15
