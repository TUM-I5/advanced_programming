...
..B1.13:                        # Preds ..B1.1
        ...
        vmovupd   ymm1, YMMWORD PTR .L_2il0floatpacket.0[rip]   #31.17
        vmovupd   ymm0, YMMWORD PTR .L_2il0floatpacket.1[rip]   #31.33
...
..B1.3:                         # Preds ..B1.2
        xor       eax, eax                                      #35.3
        vxorpd    ymm0, ymm0, ymm0                              #36.20
                                # LOE rax rbx r12 r13 r14 r15 ymm0
..B1.4:                         # Preds ..B1.4 ..B1.3
        vmovupd   ymm1, YMMWORD PTR [rsp+rax*8]                 #36.9
        vmovupd   ymm2, YMMWORD PTR [2048+rsp+rax*8]            #40.29
        vmovupd   ymm7, YMMWORD PTR [32+rsp+rax*8]              #36.9
        vmovupd   ymm8, YMMWORD PTR [2080+rsp+rax*8]            #40.29
        vmovupd   ymm13, YMMWORD PTR [64+rsp+rax*8]             #36.9
        vmovupd   ymm14, YMMWORD PTR [2112+rsp+rax*8]           #40.29
        vmulpd    ymm4, ymm1, ymm2                              #37.29
        vmulpd    ymm10, ymm7, ymm8                             #37.29
        vcmpltpd  ymm5, ymm1, ymm0                              #36.20
        vaddpd    ymm3, ymm1, ymm2                              #40.29
        vcmpltpd  ymm1, ymm13, ymm0                             #36.20
        vaddpd    ymm15, ymm13, ymm14                           #40.29
        vcmpltpd  ymm11, ymm7, ymm0                             #36.20
        vaddpd    ymm9, ymm7, ymm8                              #40.29
        vmulpd    ymm13, ymm13, ymm14                           #37.29
        vblendvpd ymm6, ymm3, ymm4, ymm5                        #40.29
        vblendvpd ymm12, ymm9, ymm10, ymm11                     #40.29
        vblendvpd ymm2, ymm15, ymm13, ymm1                      #40.29
        vmovupd   ymm3, YMMWORD PTR [96+rsp+rax*8]              #36.9
        vmovupd   ymm4, YMMWORD PTR [2144+rsp+rax*8]            #40.29
        vmovupd   YMMWORD PTR [4096+rsp+rax*8], ymm6            #37.7
        vmovupd   YMMWORD PTR [4128+rsp+rax*8], ymm12           #37.7
        vmovupd   YMMWORD PTR [4160+rsp+rax*8], ymm2            #37.7
        vmulpd    ymm6, ymm3, ymm4                              #37.29
        vcmpltpd  ymm7, ymm3, ymm0                              #36.20
        vaddpd    ymm5, ymm3, ymm4                              #40.29
        vblendvpd ymm8, ymm5, ymm6, ymm7                        #40.29
        vmovupd   YMMWORD PTR [4192+rsp+rax*8], ymm8            #37.7
        add       rax, 16                                       #35.3
        cmp       rax, 256                                      #35.3
...
..B1.6:                         # Preds ..B1.8 ..B1.5
        mov       edi, offset flat: _ZSt4cout                   #46.15
        vmovsd    xmm0, QWORD PTR [4096+rsp+r12*8]              #46.15
        vzeroupper                                              #46.15
..___tag_value_main.9:                                          #46.15
        call      _ZNSolsEd                                     #46.15
..___tag_value_main.10:                                         #
                                # LOE rax rbx r12 r13 r14 r15
..B1.7:                         # Preds ..B1.6
        mov       rdi, rax                                      #46.27
        mov       esi, offset flat: .L_2__STRING.0              #46.27
..___tag_value_main.11:                                         #46.27
        call      _ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc #46.27
..___tag_value_main.12:                                         #
                                # LOE rbx r12 r13 r14 r15
..B1.8:                         # Preds ..B1.7
        inc       r12                                           #45.40
        cmp       r12, 256                                      #45.27
        jl        ..B1.6        # Prob 99%                      #45.27
                                # LOE rbx r12 r13 r14 r15
..B1.9:                         # Preds ..B1.8
        mov       edi, offset flat: _ZSt4cout                   #48.13
        mov       esi, offset flat: _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_ #48.13
..___tag_value_main.13:                                         #48.13
        call      _ZNSolsEPFRSoS_E                              #48.13
..___tag_value_main.14:                                         #
                                # LOE rbx r12 r13 r14 r15
..B1.10:                        # Preds ..B1.9
        xor       eax, eax                                      #49.1
        add       rsp, 6264                                     #49.1
..___tag_value_main.15:                                         #49.1
        pop       r12                                           #49.1
        mov       rsp, rbp                                      #49.1
        pop       rbp                                           #49.1
