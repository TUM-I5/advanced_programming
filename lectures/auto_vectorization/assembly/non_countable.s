...
..B1.2:                         # Preds ..B1.2 ..B1.16
        vmovupd   YMMWORD PTR [2048+rsp+rax*8], ymm1            #29.5
        vmovupd   YMMWORD PTR [4096+rsp+rax*8], ymm0            #29.22
        vmovupd   YMMWORD PTR [2080+rsp+rax*8], ymm1            #29.5
        vmovupd   YMMWORD PTR [4128+rsp+rax*8], ymm0            #29.22
        vmovupd   YMMWORD PTR [2112+rsp+rax*8], ymm1            #29.5
        vmovupd   YMMWORD PTR [4160+rsp+rax*8], ymm0            #29.22
        vmovupd   YMMWORD PTR [2144+rsp+rax*8], ymm1            #29.5
        vmovupd   YMMWORD PTR [4192+rsp+rax*8], ymm0            #29.22
        add       rax, 16                                       #28.3
        cmp       rax, 256                                      #28.3
        jb        ..B1.2        # Prob 99%                      #28.3
                                # LOE rax rbx r12 r13 r14 r15 ymm0 ymm1
..B1.3:                         # Preds ..B1.2
        vmovsd    xmm0, QWORD PTR .L_2il0floatpacket.2[rip]     #35.20
        xor       eax, eax                                      #33.16
                                # LOE rax rbx r12 r13 r14 r15 xmm0
..B1.4:                         # Preds ..B1.5 ..B1.3
        vmovsd    xmm1, QWORD PTR [4096+rsp+rax*8]              #35.9
        vcomisd   xmm0, xmm1                                    #35.20
        ja        ..B1.7        # Prob 20%                      #35.20
                                # LOE rax rbx r12 r13 r14 r15 xmm0 xmm1
..B1.5:                         # Preds ..B1.4
        vmulsd    xmm1, xmm1, QWORD PTR [2048+rsp+rax*8]        #38.27
        vmovsd    QWORD PTR [rsp+rax*8], xmm1                   #38.5
        inc       rax                                           #33.40
        cmp       rax, 256                                      #33.27
        jl        ..B1.4        # Prob 99%                      #33.27
                                # LOE rax rbx r12 r13 r14 r15 xmm0
...
..B1.8:                         # Preds ..B1.10 ..B1.7
        mov       edi, offset flat: _ZSt4cout                   #43.15
        vmovsd    xmm0, QWORD PTR [rsp+r12*8]                   #43.15
        vzeroupper                                              #43.15
..___tag_value_main.9:                                          #43.15
        call      _ZNSolsEd                                     #43.15
..___tag_value_main.10:                                         #
                                # LOE rax rbx r12 r13 r14 r15
..B1.9:                         # Preds ..B1.8
        mov       rdi, rax                                      #43.27
        mov       esi, offset flat: .L_2__STRING.0              #43.27
..___tag_value_main.11:                                         #43.27
        call      _ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc #43.27
..___tag_value_main.12:                                         #
                                # LOE rbx r12 r13 r14 r15
..B1.10:                        # Preds ..B1.9
        inc       r12                                           #42.40
        cmp       r12, 256                                      #42.27
        jl        ..B1.8        # Prob 99%                      #42.27
                                # LOE rbx r12 r13 r14 r15
..B1.11:                        # Preds ..B1.10
        mov       edi, offset flat: _ZSt4cout                   #45.13
        mov       esi, offset flat: _ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_ #45.13
..___tag_value_main.13:                                         #45.13
        call      _ZNSolsEPFRSoS_E                              #45.13
..___tag_value_main.14:                                         #
                                # LOE rbx r12 r13 r14 r15
..B1.12:                        # Preds ..B1.11
        xor       eax, eax                                      #46.1
        add       rsp, 6264                                     #46.1
..___tag_value_main.15:                                         #46.1
        pop       r12                                           #46.1
        mov       rsp, rbp                                      #46.1
        pop       rbp                                           #46.1
